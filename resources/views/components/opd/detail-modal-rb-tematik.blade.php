        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] flex flex-col">
            ...
            <div class="flex justify-between items-center bg-green-600 text-white p-6 rounded-t-lg flex-shrink-0">
                <h3 class="text-xl font-semibold flex items-center gap-2">
                    Detail Rencana Aksi RB Tematik <span id="detailTahunHeader">{{ $currentYear ?? date('Y') }}</span>
                </h3>
            </div>
            ...
            <div class="flex-1 overflow-y-auto p-6">
                <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <div class="mb-6 p-4 bg-indigo-50 rounded-lg">
                        ...
                        <input type="text" id="detailAnggaranTahun" name="anggaran_tahun"
                            placeholder="Masukkan anggaran {{ $selectedYear ?? $currentYear ?? date('Y') }}" readonly
                            class="w-full p-2 border border-gray-200 rounded-md bg-gray-50 text-black-400 font-medium">
                    </div>
                    <!-- Anggaran TW -->
