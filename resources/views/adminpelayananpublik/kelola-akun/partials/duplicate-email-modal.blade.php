...
<div id="duplicateEmailModal"
    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden">
        <div class="bg-yellow-500 p-4 flex justify-between items-center">
            ...
            <button type="button" onclick="closeModal('duplicateEmailModal')" class="text-white hover:text-gray-200">
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-gray-500 italic">
                        <i class="fas fa-info-circle"></i> Gunakan email yang berbeda untuk membuat akun OPD baru.
                    </p>
                </div>
            </div>
        </div>
