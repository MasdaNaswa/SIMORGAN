...
class LoginController extends Controller
{
    ...
    public function showLoginForm()
    {
        $opdList = [
            ...
            'dinas_pemberdayaan_perempuan_dan_perlindungan_anak' => 'Dinas Pemberdayaan Perempuan dan Perlindungan Anak',
            ...
            'dinas_pariwisata' => 'Dinas Pariwisata',
            ...
            'kecamatan_ungar' => 'Kecamatan Ungar',
            'ptsp' => 'PTSP',
            'rsud' => 'RSUD M.SANI',
    ...
    public function login(Request $request)
    {
        ...
        if ($role === 'opd') {
            ...
            // ✅ LANGSUNG LOGIN, TIDAK PERU MILIH OPD LAGI
            Auth::login($user);
            
            // ✅ Simpan nama_opd ke session untuk keperluan view
            session(['opd_name' => $user->nama_opd]);
