<div id="addOPDModal" class="hidden fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-[9999] p-4">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md overflow-y-auto">
        ...
        <form id="formTambahAkun" class="p-6 space-y-4">
            @csrf
            <div>
            ...
            <div>
                ...
                <select name="role" class="w-full p-2 border rounded-md bg-gray-100" disabled>
                    <option value="OPD" class="text-gray-700">OPD</option>
                </select>
            ...
            <div class="flex justify-end gap-2 pt-2">
                ...
                <button type="button" onclick="cekEmailSebelumSubmit()" 
