  ...
  <div class="bg-white rounded-lg shadow-xl w-full max-w-md overflow-y-auto">
    ...
    <form id="formTambahAkun" method="POST" class="p-6 space-y-4">
      ...
      <div>
        ...
        <input type="text" name="nama_opd" id="nama_opd"  placeholder="Masukkan nama OPD"
          class="w-full p-2 border rounded-md focus:ring-2 focus:ring-green-500" required>
      </div>

      <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
        <input type="email" name="email" id="emailInput"  placeholder="Masukkan email"
          class="w-full p-2 border rounded-md focus:ring-2 focus:ring-green-500" required>
      ...
      <div>
        ...
        <div class="relative">
          <input type="password" name="password" id="password"  placeholder="Masukkan kata sandi"
            class="w-full p-2 border rounded-md focus:ring-2 focus:ring-green-500 pr-10" required>
        ...
        <p class="text-gray-500 text-xs mt-1">Minimal 8 karakter, mengandung huruf besar, huruf kecil, angka, dan simbol
          (@$!%*?&#)</p>
      </div>

      <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Role</label>
        <select name="role" id="roleSelect" class="w-full p-2 border rounded-md bg-gray-100" disabled>
      ...
      <div class="flex justify-end gap-2">
        ...
        <button type="button" id="btnTambahAkun"
