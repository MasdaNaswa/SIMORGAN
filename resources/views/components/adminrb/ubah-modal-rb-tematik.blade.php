        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto p-6">
                ...
                <form id="editRenaksiRB" method="POST" action="" class="space-y-6">
                    @csrf
                    <!-- PASTIKAN INI ADA - method PUT untuk update -->
                    @method('PUT')

                    <input type="hidden" id="edit_id" name="id">
                    <input type="hidden" name="tahun" value="{{ $selectedYear ?? $currentYear ?? date('Y') }}" id="editTahunAnggaran">
                    ...
                    <div class="p-6 bg-gray-50 rounded-lg border-l-4 border-amber-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div>
                                <label for="edit_sasaran_tematik" class="block text-sm font-medium text-gray-700 mb-1">SASARAN TEMATIK</label>
                        ...
                        <div class="mt-4">
                            <label for="edit_target_tahun" class="block text-sm font-medium text-gray-700 mb-1">
                                TARGET TAHUN <span class="text-gray-700">{{ $selectedYear }}</span>
                            </label>
                            <input type="text" id="edit_target_tahun" name="target_tahun" maxlength="100"
                                placeholder="Masukkan target tahun {{ $selectedYear }}"
                                class="w-full p-2 border border-gray-300 rounded-md focus:ring-amber-500 focus:border-amber-500" 
                                required />
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div>
                                <label for="edit_satuan_output" class="block text-sm font-medium text-gray-700 mb-1">SATUAN OUTPUT</label>
                                <input type="text" id="edit_satuan_output" name="satuan_output" maxlength="255"
                                    class="w-full p-2 border border-gray-300 rounded-md focus:ring-amber-500 focus:border-amber-500" />
                            </div>
                            <div>
                                <label for="edit_indikator_output" class="block text-sm font-medium text-gray-700 mb-1">INDIKATOR OUTPUT</label>
                    ...
                    <div class="p-6 bg-gray-50 rounded-lg border-l-4 border-blue-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 pb-4 {{ !$loop->last ? 'border-b border-gray-200' : '' }}">
                            <div>
                                <label for="edit_tw{{ $tw }}_target" class="block text-sm font-medium text-gray-700 mb-1">
                                    TW{{ $tw }} - Target
                                </label>
                    ...
                    <div class="p-6 bg-gray-50 rounded-lg border-l-4 border-green-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                <label for="edit_realisasi_tw1_target" class="block text-sm font-medium text-gray-700 mb-1">
                                    TW1 Realisasi Target
                                </label>
                                <input type="text" id="edit_realisasi_tw1_target" name="realisasi_renaksi_tw1_target"
                            ...
                            <div>
                                ...
                                <input type="text" id="edit_realisasi_tw1_rp" name="realisasi_renaksi_tw1_rp"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                <label for="edit_realisasi_tw2_target" class="block text-sm font-medium text-gray-700 mb-1">
                                    TW2 Realisasi Target
                                </label>
                                <input type="text" id="edit_realisasi_tw2_target" name="realisasi_renaksi_tw2_target"
                            ...
                            <div>
                                ...
                                <input type="text" id="edit_realisasi_tw2_rp" name="realisasi_renaksi_tw2_rp"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                <label for="edit_realisasi_tw3_target" class="block text-sm font-medium text-gray-700 mb-1">
                                    TW3 Realisasi Target
                                </label>
                                <input type="text" id="edit_realisasi_tw3_target" name="realisasi_renaksi_tw3_target"
                            ...
                            <div>
                                ...
                                <input type="text" id="edit_realisasi_tw3_rp" name="realisasi_renaksi_tw3_rp"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="edit_realisasi_tw4_target" class="block text-sm font-medium text-gray-700 mb-1">
                                    TW4 Realisasi Target
                                </label>
                                <input type="text" id="edit_realisasi_tw4_target" name="realisasi_renaksi_tw4_target"
                            ...
                            <div>
                                ...
                                <input type="text" id="edit_realisasi_tw4_rp" name="realisasi_renaksi_tw4_rp"
                    ...
                    <div class="p-6 bg-gray-50 rounded-lg border-l-4 border-purple-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="edit_koordinator" class="block text-sm font-medium text-gray-700 mb-1">KOORDINATOR</label>
                            ...
                            <div>
                                <label for="edit_pelaksana" class="block text-sm font-medium text-gray-700 mb-1">PELAKSANA</label>
                                <select id="edit_pelaksana" name="pelaksana"
                                    ...
                                    <option value="Dinas Tenaga Kerja dan Perindustrian">Dinas Tenaga Kerja dan Perindustrian</option>
                                    ...
                                    <option value="Dinas Perumahan Rakyat dan Kawasan Pemukiman">Dinas Perumahan Rakyat dan Kawasan Pemukiman</option>
