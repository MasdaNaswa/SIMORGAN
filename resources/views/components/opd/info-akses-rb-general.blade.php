                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            ...
                            <div id="infoAksesDeadlineContainer" class="mt-3 hidden">
                                <p class="text-sm text-gray-700">
                                    <span class="font-semibold">Deadline:</span> 
                            <span id="infoAksesDeadline" class="text-gray-600"></span>
                                </p>
                            </div>
                            
                            <!-- Informasi tanggal buka (jika akan dibuka) -->
                            <div id="infoAksesStartDateContainer" class="mt-1 hidden">
                                <p class="text-sm text-gray-700">
                                    <span class="font-semibold">Akan dibuka:</span> 
                                    <span id="infoAksesStartDate" class="text-gray-600"></span>
                                </p>
                            </div>
                            
                            <!-- Informasi tambahan -->
                            <p class="text-xs text-gray-400 mt-3">
                                * Anda masih dapat melihat, mengedit, dan menghapus data yang sudah ada.
                            </p>
                        </div>
                    </div>
                </div>
