        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] flex flex-col">
            ...
            <div class="flex justify-between items-center bg-green-600 text-white p-6 rounded-t-lg flex-shrink-0">
                <h3 class="text-xl font-semibold flex items-center gap-2">
                    <i class="fas fa-eye"></i> Detail Data PK Bupati
                </h3>
            </div>
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <div class="mb-6 p-6 bg-white rounded-lg border-l-4 border-blue-500 shadow-sm">
                        ...
                        <div class="tab flex border border-gray-300 bg-gray-100 rounded-t-md overflow-hidden mb-4">
                            <button type="button"
                                class="tablinks px-4 py-2 bg-white font-medium active border-b-2 border-green-600 text-green-700"
                                onclick="openDetailTab(event, 'detailTriwulan1')">Triwulan I</button>
                            <button type="button"
                                class="tablinks px-4 py-2 bg-gray-100 font-medium text-gray-700 hover:bg-gray-200"
                        ...
                        <div id="detailTriwulan1" class="tabcontent">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50" id="detailTargetTW1">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Realisasi TW1</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50"
                                        id="detailRealisasiTW1"></div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Pagu Anggaran
                                        TW1</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50" id="detailPaguTW1">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Realisasi Anggaran
                                        TW1</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50"
                                        id="detailRealisasiAnggaranTW1"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="detailTriwulan2" class="tabcontent hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50" id="detailTargetTW2">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Realisasi TW2</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50"
                                        id="detailRealisasiTW2"></div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Pagu Anggaran
                                        TW2</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50" id="detailPaguTW2">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Realisasi Anggaran
                                        TW2</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50"
                                        id="detailRealisasiAnggaranTW2"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="detailTriwulan3" class="tabcontent hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50" id="detailTargetTW3">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Realisasi TW3</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50"
                                        id="detailRealisasiTW3"></div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Pagu Anggaran
                                        TW3</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50" id="detailPaguTW3">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Realisasi Anggaran
                                        TW3</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50"
                                        id="detailRealisasiAnggaranTW3"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="detailTriwulan4" class="tabcontent hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50" id="detailTargetTW4">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Realisasi TW4</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50"
                                        id="detailRealisasiTW4"></div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Pagu Anggaran
                                        TW4</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50" id="detailPaguTW4">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Realisasi Anggaran
                                        TW4</label>
                                    <div class="p-2 border border-gray-200 rounded-md bg-gray-50"
                                        id="detailRealisasiAnggaranTW4"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6 p-6 bg-white rounded-lg border-l-4 border-green-500 shadow-sm">
                        ...
                        <!-- Grid 2 kolom untuk Program dan Penanggung Jawab -->
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Program</label>
                                <div id="detailProgram"
                                    class="p-2 border border-gray-200 rounded-md bg-gray-50 min-h-[42px]"></div>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Penanggung Jawab</label>
                                <div id="detailPenanggungJawab"
                                    class="p-2 border border-gray-200 rounded-md bg-gray-50 min-h-[42px]"></div>
                            </div>
                        </div>

                        <!-- Analisis Evaluasi tetap di bawah (full width) -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Penjelasan Analisis dan
                                Evaluasi</label>
                            <div id="detailAnalisisEvaluasi" class="p-2 border border-gray-200 rounded-md bg-gray-50">
                            </div>
                        </div>
                    </div>
                </div>
